						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6">
											<form role="form" action="<%=basePath%>mana/savestore"
												method="post" 
												onsubmit="return validate_required()">
												<div class="form-group">
													<label>店铺名称</label> <input class="form-control"
														placeholder="请输入店铺名称" name="name"
														value="${requestScope.st.name }" id="name">
													<input type="hidden" name="id" id="id"
														value="${requestScope.st.id }">
												</div>
												<div class="form-group">
													<label>所在城市</label> <input class="form-control"
														placeholder="请输入所在城市" name="city"
														value="${requestScope.st.city }" id="city">
												</div>
												<div class="form-group">
													<label>详细地址</label> <input class="form-control"
														placeholder="请输入详细地址" name="address"
														value="${requestScope.st.address}" id="address">
												</div>
												<div class="form-group">
													<label>联系电话</label> <input class="form-control"
														placeholder="请输入联系电话" name="tel"
														value="${requestScope.st.tel}" id="tel" type="number" pattern="[0-9]*">
												</div>
												<div class="form-group">
													<label>经度</label> <input class="form-control"
														placeholder="请在地图上选择" name="longitude"
														value="${requestScope.st.longitude}" id="longitude" disabled="disabled">
												</div>
												<div class="form-group">
													<label>纬度</label> <input class="form-control"
														placeholder="请在地图上选择" name="latitude"
														value="${requestScope.st.latitude}" id="latitude" disabled="disabled">
												</div>
										...
										<div class="col-lg-6">
										<div id="container" style="width: 100%;height:500px;overflow: hidden;margin:0;font-family:"微软雅黑";"></div>
										</div>
										<!-- /.panel-body -->
									</div>
									<!-- /.panel -->
