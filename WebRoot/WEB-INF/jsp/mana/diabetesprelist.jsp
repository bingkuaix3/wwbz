...
<body>
	<div id="wrapper">
				...
				<ul class="nav" id="side-menu">
					<%-- <li><a href="#"><i class="glyphicon glyphicon-time"></i>
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="<%=basePath%>mana/diabetesprelist"  class="active">血糖仪未处理列表</a></li>
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">血糖仪未处理列表</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
									...
									<tbody style="cursor: pointer;">
										<c:forEach var="mi" items="${requestScope.list}">
											<tr class="odd gradeX">
												...
												<td>${mi.address}</td>
												<td><c:choose>
														<c:when test="${mi.paper==1}">
												是
												</c:when>
														<c:otherwise>否</c:otherwise>
													</c:choose></td>
													<td onclick="deal(${mi.id})"><i class="glyphicon glyphicon-edit"></i></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
 ...
 --%>
		...
		function deal(i) {
			...
			$.ajax({
				type : "POST",
				url : "<%=basePath%>mana/dealdiabetes",
						data : {
							"id" : i
						},
