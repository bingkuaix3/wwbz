...
<%-- 					<li><a href="#"><i class="glyphicon glyphicon-time"></i>
						...
						<ul class="nav nav-second-level">
							<li><a href="<%=basePath%>mana/basicwwbz" class="active">基本内容设置</a></li>
						</ul> <!-- /.nav-second-level --></li>
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">小程序基本设置</h1>
					</div>
					<!-- /.col-lg-12 -->
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6">
											<form role="form" action="<%=basePath%>mana/changebasicwwbz"
												method="post" enctype="multipart/form-data"
												onsubmit="return validate_required()">
												<div class="form-group">
													<label>微金豆（积分说明）</label>
													<textarea rows="3" cols="3" value="${requestScope.basic.reword }" name="reword" id="reword" class="form-control">${requestScope.basic.reword }</textarea>
												</div>
												<div class="form-group">
													<label>关于我们</label>
													<textarea rows="3" cols="3" value="${requestScope.basic.aboutus }" name="aboutus" id="aboutus" class="form-control">${requestScope.basic.aboutus }</textarea>
												</div>
												<div class="form-group">
													<label>购买协议</label>
													<textarea rows="3" cols="3" value="${requestScope.basic.pay }" name="pay" id="pay" class="form-control">${requestScope.basic.pay }</textarea>
												</div>
												<div class="form-group">
													<label>海报图片</label> <input type="file"
														name="posterurl" id="posterurl"
														onchange="changImg(event)"> <img alt="再无图片"
														id="img" src="${requestScope.basic.posterurl}" height="100px"
														style="margin-top: 2%">
												</div>
												<div class="form-group">
													<label>海报文字</label>
													<textarea rows="3" cols="3" value="${requestScope.basic.posterword }" name="posterword" id="posterword" class="form-control">${requestScope.basic.posterword }</textarea>
												</div>
												<div class="form-group">
													<label>客服联系电话</label>
													<input type="number" class="form-control" value="${requestScope.basic.tel }" name="tel" id="tel"> 
												</div>
												<div class="form-group">
													<label>从业宣言</label>
													<input class="form-control" value="${requestScope.basic.dealerword }" name="dealerword" id="dealerword"> 
												</div>
												<div class="form-group">
													<label>经销商宣传页面图片</label> <input type="file"
														name="dealerimg" id="dealerimg"
														onchange="changdImg(event)"> <img alt="再无图片"
														id="dimg" src="${requestScope.basic.dealerimg}" height="100px"
														style="margin-top: 2%">
												</div>
			...
			<script>
				...
				function validate_required() {
					if($("#reword").val()==""||$("#aboutus").val()==""||$("#tel").val()==""||$("#pay").val()==""||$("#posterword").val()==""||$("#dealerword").val()==""){
						alert("请补全信息")
						return false
					}else{
						if($("#posterurl").val()==""||$("#dealerimg").val()==""){
