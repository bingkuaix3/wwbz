...
<%-- 					<li><a href="#"><i class="glyphicon glyphicon-time"></i>
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">新增订阅号文章</h1>
					</div>
					<!-- /.col-lg-12 -->
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6">
											<form role="form" action="<%=basePath%>mana/savearticle"
												method="post" 
												onsubmit="return validate_required()">
												<div class="form-group">
													<select class="form-control" name="articlekind" id="articlekind">
														<c:forEach var="mi" items="${requestScope.akl}" >
															<c:choose>
																<c:when test="${ mi.id== requestScope.aw.kindid}">
												...
												<div class="form-group">
													<label>文章网址</label> <input class="form-control"
														...
														value="${requestScope.aw.src }" id="article_src">
												</div>
