			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					<%-- <li><a href="#"><i class="glyphicon glyphicon-time"></i>
						...
						<li><a href="<%=basePath%>mana/invitationlist" class="active"><i class="	glyphicon glyphicon-envelope"></i>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">邀请函</div>
							<!-- /.panel-heading -->
