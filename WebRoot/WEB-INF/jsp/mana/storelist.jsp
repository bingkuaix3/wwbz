			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					<%-- <li><a href="#"><i class="glyphicon glyphicon-time"></i>
						...
						<ul class="nav nav-second-level">
							<li><a href="<%=basePath%>mana/storelist"  class="active">线下店列表</a></li>
									...
									<tbody style="cursor: pointer;">
										 <c:forEach var="mi" items="${requestScope.list}">
											<tr class="odd gradeX">
												...
												<td onclick="clicklist(${mi.id})">${mi.address}</td>
	...
	<!-- Page-Level Demo Scripts - Tables - Use for reference -->
			<script>
				...
				function clicklist(i) {
					//alert("进入" + i)
					window.location.href = "<%=basePath%>mana/addstore?id=" + i;
				}
				function dellist(i) {
					var con = confirm("确定删除线下店吗？")
					if (con == true) {
						//alert("确定")
						$.ajax({
							type : "POST",
							url : "<%=basePath%>mana/delstore",
									data : {
										"id" : i
									},
