			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					<%-- <li><a href="#"><i class="glyphicon glyphicon-time"></i>
						...
						<ul class="nav nav-second-level">
							<li><a href="<%=basePath%>mana/category" class="active">商品类别管理</a></li>	
						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<button class="btn" id="nk">新增商品类别</button>
								</div>
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6">
											<c:forEach var="mi" items="${requestScope.cl}">
												<form role="form" action="<%=basePath%>mana/addcategory"
				...
				$(document).ready(function() {
					...
					$(".change").click(function(){
						if($(this).parent().children("input").val()==""){
							...
							$.ajax({
								type : "POST",
								url : "<%=basePath%>mana/changecategory",
										data : {
											"name" : $(this).parent().children("input").val(),
											"id":$(this).attr("data")
										},
