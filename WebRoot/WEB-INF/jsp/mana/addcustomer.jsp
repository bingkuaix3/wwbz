	...
	<div id="wrapper">
				...
				<ul class="nav" id="side-menu">
					<%-- <li><a href="#"><i class="glyphicon glyphicon-time"></i>
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="<%=basePath%>mana/addcustomer?id=0"  class="active">新增见证</a></li>
						</ul> <!-- /.nav-second-level --></li>
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">新增客户见证</h1>
					</div>
					<!-- /.col-lg-12 -->
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6">
											<form role="form" action="<%=basePath%>mana/savecustomer"
												method="post" enctype="multipart/form-data"
												onsubmit="return validate_required()">
												<div class="form-group">
													<label>资料名称</label> <input class="form-control"
														placeholder="请输入资料名称" name="name"
														value="${requestScope.ct.name }" id="customer_name">
													<input type="hidden" name="id" id="customer_id"
														value="${requestScope.ct.id }">
												</div>
												<div class="form-group">
													<label>见证图片</label> <input type="file"
														name="pic" id="customer_pic"
														onchange="changImg(event)"> <img alt="再无图片"
														id="myImg" src="${requestScope.ct.pic}" height="100px"
														style="margin-top: 2%">
												</div>
												<div class="form-group">
													<label>客户简介</label>
													<textarea class="form-control" rows="3" name="des"
														id="customer_des">${requestScope.ct.des}</textarea>
												</div>
			...
			<script>
				...
				function validate_required() {
					...
					if($("#customer_name").val()==""||$("#customer_des").val()==""){
						alert("请补全信息")
						return false
					}else {
						if ($("#customer_pic").val() == "") {
