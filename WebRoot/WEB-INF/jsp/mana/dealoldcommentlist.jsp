...
<body>
	<div id="wrapper">
				...
				<ul class="nav" id="side-menu">
					<%-- <li><a href="#"><i class="glyphicon glyphicon-time"></i>
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="<%=basePath%>mana/dealoldcommentlist"  class="active">老用户评论（已归类）</a></li>
						</ul> <!-- /.nav-second-level --></li>
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">老客户评论列表（通过）</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
 ...
 --%>
		...
		function clicklist(i) {
			//alert("进入" + i)
			window.location.href = "<%=basePath%>mana/oldcomment?id=" + i;
		}
		function dellist(i) {
