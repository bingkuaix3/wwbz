...
<body>
	<div id="wrapper">
			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="glyphicon glyphicon-copyright-mark"></i>
						...
						<ul class="nav nav-second-level">
							<li><a href="<%=basePath%>mana/customerlist" class="active">见证列表</a></li>
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">客户见证列表</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
	...
	<script>
		...
		function clicklist(i) {
			//alert("进入" + i)
			window.location.href = "<%=basePath%>mana/addcustomer?id=" + i;
		}
		function dellist(i) {
			var con = confirm("确定删除资料吗？")
			if (con == true) {
				//alert("确定")
				$.ajax({
					type : "POST",
					url : "<%=basePath%>mana/delcustomer",
							data : {
								"id" : i
							},
